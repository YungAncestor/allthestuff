...
Module Module1
    ...
    Sub Main()
        ...
        If FileExists("saves\ficha1.dat") = False Then
            ...
            p.name = charname
            Console.WriteLine($"   welcome {p.name}, today is [ u n d e f i n e d ] of [ 7 0 7 7 ]")
            Console.Clear()
        ...
        While index = 1
            ...
            Console.Title = "r p g   c y b e r p u n k"

            Console.ForegroundColor = ConsoleColor.White
            Console.BackgroundColor = ConsoleColor.Blue
            Console.SetCursorPosition(0, 0)
            Console.WriteLine($"           welcome, {p.name} - [ u n d e f i n e d ]  |  [ 3 0 7 7]                       ")
            ...
            ElseIf execute = "view inventory.inv" Then
                Console.Clear()
