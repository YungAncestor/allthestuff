...
Module main
    ...
    Public Sub tick(ByVal sender As Object, ByVal e As System.Timers.ElapsedEventArgs)
        ...
        'write(currentFrameRate & " fps", green, 2, 1)
    End Sub
    ...
    Function start1()
        ...
        While Not done
            For i As Integer = 0 To optionsCount - 1
                ...
                If i = 0 Then Console.WriteLine("  eLparedero’s menyoo")
                If i = 1 Then Console.WriteLine()
                'If i = 2 Then Console.WriteLine("  " & currentFrameRate & " fps")
